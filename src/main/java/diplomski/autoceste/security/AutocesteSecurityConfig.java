...
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true) //needed for @PreAuthorize annotation
public class AutocesteSecurityConfig extends WebSecurityConfigurerAdapter {
